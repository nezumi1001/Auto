...
from Public.Pages.Conference.status_page import StatusPage
...
if __name__ == "__main__":
    ...
    cases.addTest(MainPage('test_status'))
    ...
    SendMail.send_report(report_path, att_type='pdf', mail_title='Localization Status')
